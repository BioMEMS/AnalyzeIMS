...
file_loc = 'C:\Users\Reid Honeycutt\Documents\AdvancedSolutions\Contaminated';
...
for file = files'
    ...
    hdr_file_name = fullfile(output_folder, [S2(1:end-8), 'Hdr.xls']);

    curr_pos_name = fullfile(S1,S2);
    new_pos_name = fullfile(output_folder, S2);
    new_neg_name = fullfile(output_folder, [S2(1:end-8), 'Neg.xlsx']);
