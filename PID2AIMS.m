...
file_loc = 'C:\Users\Reid Honeycutt\Documents\Kory PID Data May 25';
...
for file = files'
    ...
    hdr_file_name = fullfile(output_folder, [S2(1:end-4), '_Hdr.xls']);

    curr_pos_name = fullfile(S1,S2);
    new_pos_name = fullfile(output_folder, [S2(1:end-4), '_Pos.csv']);
